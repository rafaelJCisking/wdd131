...
def test_water_column_height():
    # Test case 1
    assert water_column_height(0.0, 0.0) == pytest.approx(0.0, abs=0.001)
    # Test case 2
    assert water_column_height(0.0, 10.0) == pytest.approx(7.5, abs=0.001)
    # Test case 3
    assert water_column_height(25.0, 0.0) == pytest.approx(25.0, abs=0.001)
    # Test case 4
